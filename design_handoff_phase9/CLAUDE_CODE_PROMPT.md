...
6. `07-desktop-spec.md` (Phase 9 — the owner/HR desktop workspace at ≥1024px, incl. the employee drawer)
7. `04-phases-and-acceptance.md` — 9 phases; work phase-by-phase
