...
- `04-phases-and-acceptance.md` — 9 phases with acceptance criteria + test plan
- `05-login-spec.md` — login screen (waves, glass card, sheen button)
- `07-desktop-spec.md` — **desktop workspace**: shell, content patterns, every view, employee drawer
- `06-hybrid-map-spec.md` — **APPROVED final direction for اليوم**: map card + geofence states; read it BEFORE Phase 3
