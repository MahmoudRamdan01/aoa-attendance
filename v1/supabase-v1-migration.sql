...
create policy daily_qr_broadcasts_admin_read on daily_qr_broadcasts for select to authenticated using (is_hr());
...
begin
  ...
  perform notify_owners('طلب إذن جديد','يوجد طلب إذن جديد يحتاج موافقة Owner.');
...
begin
  ...
  perform notify_owners('طلب أجازة جديد','يوجد طلب أجازة جديد يحتاج موافقة Owner.');
