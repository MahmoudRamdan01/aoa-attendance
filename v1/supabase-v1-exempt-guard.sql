-- =====================================================================
--  Air Ocean Line — v1: attendance_exempt guard (2026-07-10)
--  Run AFTER supabase-v1-ops-update.sql (adds employees.attendance_exempt).
--  * employee_attendance_action_v1: exempt employees cannot check in/out
--  * mark_absentees_v1: exempt employees are never auto-marked absent
--  Idempotent (create or replace). Applied to live DB as migration
--  "attendance_action_exempt_guard".
-- =====================================================================
